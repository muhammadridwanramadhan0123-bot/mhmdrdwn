...

  {
    ...
    items: [
...

      {
        ...
        description:
          "Profil dan informasi perusahaan",
    ...
    items: [
      {
        ...
        description:
          "Identitas, kontak dan media sosial",
...
function getCurrentPage(
  ...
  if (
    ...
    return {
      ...
      description:
        "Kelola identitas website, kontak, lokasi, media sosial, dan pengaturan global.",
    };
  }

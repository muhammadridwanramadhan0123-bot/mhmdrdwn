...
export default function AdminCompanyPage() {
  ...
  const sectionInformation = useMemo(
    () => ({
      "about-us": {
        value: summary.profileReady ? "Lengkap" : "Belum lengkap",
        status: summary.profileReady,
        secondaryText:
      ...
      location: {
        value: summary.locationReady
          ? "Lengkap"
          : "Belum lengkap",
        status: summary.locationReady,
        secondaryText:
          "Kontak dan lokasi kantor",
      },
      milestones: {
        value: summary.milestones,
        status: summary.activeMilestones > 0,
        secondaryText: `${summary.activeMilestones} aktif`,
      },
      partners: {
        value: summary.partners,
        status: summary.activePartners > 0,
        secondaryText: `${summary.activePartners} aktif`,
      },
      careers: {
        value: summary.careers,
        status: summary.openCareers > 0,
        secondaryText: `${summary.openCareers} lowongan dibuka`,
      },
    }),
    [summary]
  );
  ...
  function handleSectionChange(event) {
    ...
    navigate(`/admin/company/${selectedValue}`);
  }
      ...
      <section className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
        <div>
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-500">
            Kelola profil perusahaan, lokasi,
            milestone, partner, dan lowongan
            pekerjaan dari satu halaman.
          </p>
        </div>
        ...
        <>
          ...
          <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            <article className="rounded-3xl bg-[#082B3A] p-6 text-white">
              ...
              <p className="mt-7 text-3xl font-bold">
                {summary.profileReady ? "Siap" : "Periksa"}
              </p>
          ...
          <section>
            <div>
              ...
              <p className="mt-2 text-sm text-slate-500">
                Klik salah satu modul untuk membuka
            ...
            <div className="mt-7 grid gap-5 sm:grid-cols-2 xl:grid-cols-3">
              {companySections.map((section) => {
                ...
                const information =
                  sectionInformation[section.key];
